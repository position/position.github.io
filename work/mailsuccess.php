...
if(!mail($receiver, $subject, $mailbody, $headers, "-f ".$to_mail)) goUrl("이메일 발송해 실패 하였습니다.");
else 
goUrl('메일이 정상적으로 발송되었습니다.', 'index.php');
?>